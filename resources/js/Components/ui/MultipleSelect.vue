<template>
  <div class="relative" ref="multiSelectRef">
    ...
    >
      <span v-if="selectedItems.length === 0" class="text-gray-400">{{ t('common.selectItems') }}</span>
    ...
    >
      <div
        v-if="isOpen"
        class="absolute z-10 w-full bg-white rounded-lg shadow-sm dark:bg-gray-900"
...
const decideDirection = () => {
  ...
  const desired = 240 // matches max-h-60 (15rem)
  openUp.value = spaceBelow < desired && spaceAbove > spaceBelow
}
