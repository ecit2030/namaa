  ...
  <section id="mobile-app" class="relative py-20 lg:py-28 bg-white">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-14">
        ...
        <p class="text-lg text-brand-dark/90 max-w-2xl mx-auto mb-8">
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
          <a
            href="#"
            class="inline-flex items-center gap-3 px-6 py-3.5 rounded-lg bg-brand-dark text-white font-medium text-sm hover:bg-brand-black transition-colors"
          >
      ...
      <div class="grid lg:grid-cols-3 gap-6 lg:gap-8">
        <article
          ...
          :key="index"
          class="rounded-xl border border-gray-200 p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow bg-white"
        ...
        >
          ...
          <div
            v-else
            class="w-16 h-24 mx-auto mb-5 rounded-xl flex items-center justify-center bg-brand-dark text-white"
          >
          ...
          <p class="text-gray-700 leading-relaxed text-sm text-center">
            {{ feature.description }}
          </p>
        </article>
      </div>
